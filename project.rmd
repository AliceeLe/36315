...
Purchase Amount vs. Frequency of Purchases
Add a regression line for interpretation.

✅ Bar Chart

Average Purchase Amount by Location
Locations as bars, average spending on the y-axis.
...
2. Does customer loyalty (Frequency of Purchases or Subscription Status) influence the likelihood of using discounts or promo codes?
...
Discount Applied (Yes/No) by Subscription Status
Shows whether subscribers use more discounts.

✅ Clustered Bar Chart

Promo Code Used vs. Frequency of Purchases groups
Example grouping: Low / Medium / High frequency.

✅ Heatmap or Mosaic Plot

Shows relationships among two categorical variables:
...
Frequency of Purchases vs. Average Discount Applied
If frequency is truly numeric and continuous, this can show trends.


3. How do product attributes (Category, Size, Color, Season) affect customer satisfaction (Review Rating)?
